...
export default function ItemCard({ item, onUpdate, compact = false, readonly = false }) {
  ...
  return (
    <div className={`group glass glass-hover rounded-lg ${compact ? 'px-3 py-2' : 'px-4 py-3'} transition-all ${item.is_pinned ? 'border-blue-500/20' : ''} ${editing || showDatePicker || showRecurrencePicker ? 'relative z-40' : ''}`}>
